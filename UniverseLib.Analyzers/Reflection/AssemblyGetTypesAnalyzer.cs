...
namespace UniverseLib.Analyzers.Reflection
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class AssemblyGetTypesAnalyzer : DiagnosticAnalyzer
    {
        public const string ID = "ULib011";

        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            ID,
            "Use assembly.TryGetTypes() instead of assembly.GetTypes()",
            "Use assembly.TryGetTypes() instead of assembly.GetTypes()",
            "UniverseLib.Reflection",
        ...
        private void AnalyzeSimpleMemberAccess(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                if (contextType.Name == "ReflectionExtensions"
                    && contextType.NamespaceEquals("UniverseLib"))
                    return;
            }
            
            if (symbol.Name == "GetTypes"
                && symbol.ContainingType.Name == "Assembly" 
                & symbol.ContainingType.NamespaceEquals("System.Reflection"))
